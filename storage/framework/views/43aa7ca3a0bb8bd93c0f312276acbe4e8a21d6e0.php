...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title"><?php echo e(__('Content Email Candidate Apply Job Submit')); ?></h3>
        <div class="form-group-desc">
            <?php $__currentLoopData = \Modules\Job\Listeners\SendMailApplyJobSubmitListener::CODE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <textarea name="content_email_apply_job_submit" class="d-none has-ckeditor" cols="30" rows="10"><?php echo e(setting_item_with_lang('content_email_apply_job_submit',request()->query('lang')) ?? ''); ?></textarea>
                    </div>
                </div>
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title"><?php echo e(__('Content Email Employer Change Applicants Status')); ?></h3>
        <div class="form-group-desc">
            <?php $__currentLoopData = \Modules\Job\Listeners\SendMailChangeApplicantsStatusListen::CODE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div><code><?php echo e($value); ?></code></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label><?php echo e(__("Content")); ?></label>
                    <div class="form-controls">
                        <textarea name="content_email_change_applicants_status" class="d-none has-ckeditor" cols="30" rows="10"><?php echo e(setting_item_with_lang('content_email_change_applicants_status',request()->query('lang')) ?? ''); ?></textarea>
                    </div>
                </div>
...
<?php /**PATH /Users/macbook/GitHub/superio200/modules/Email/Views/admin/settings/email.blade.php ENDPATH**/ ?>