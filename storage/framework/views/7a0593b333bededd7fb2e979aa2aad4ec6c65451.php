<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('candidate.admin.category.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="container">
            <div class="d-flex justify-content-between mb20">
                ...
                <div class="">
                    <?php if($row->slug): ?>
                        <a class="btn btn-primary btn-sm" href="<?php echo e(route('candidate.index', ['category' => $row->id])); ?>" target="_blank"><?php echo e(__("View Category")); ?></a>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <div class="col-md-9">
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                <?php echo $__env->make('Candidate::admin/category/form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/forkomdi/ciptawiratirta.com/modules/Candidate/Views/admin/category/detail.blade.php ENDPATH**/ ?>