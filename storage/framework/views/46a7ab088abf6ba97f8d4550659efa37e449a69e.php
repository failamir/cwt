                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    <select name="header_style" class="form-control" >
                                        ...
                                        <option value="header-style-two" <?php echo e(( $row->header_style ?? '') == 'header-style-two' ? 'selected' : ''); ?>><?php echo e(__('Style 2')); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    <select name="footer_style" class="form-control" >
                                        ...
                                        <option value="style-two" <?php if(($row->footer_style ?? '') == 'style-two'): ?> selected <?php endif; ?>><?php echo e(__("Style 2")); ?></option>
                                        <option value="alternate" <?php if(($row->footer_style ?? '') == 'alternate'): ?> selected <?php endif; ?>><?php echo e(__("Style 3")); ?></option>
                                        <option value="alternate3" <?php if(($row->footer_style ?? '') == 'alternate3'): ?> selected <?php endif; ?>><?php echo e(__("Style 4")); ?></option>
                                        <option value="style-six" <?php if(($row->footer_style ?? '') == 'style-six'): ?> selected <?php endif; ?>><?php echo e(__("Style 5")); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="panel">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/forkomdi/jobs.ciptawiratirta.com/modules/Page/Views/admin/detail.blade.php ENDPATH**/ ?>