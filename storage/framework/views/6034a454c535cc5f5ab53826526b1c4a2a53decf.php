                    ...
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo e($row->code); ?>" placeholder="<?php echo e(__('Role Code')); ?>" name="code" class="form-control">
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/forkomdi/ciptawiratirta.com/modules/User/Views/admin/role/detail.blade.php ENDPATH**/ ?>