<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <div class="filter-div d-flex justify-content-between ">
            ...
            <div class="col-left">
               <form method="get" action="<?php echo e(url('/admin/module/page/')); ?> " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                            ...
                            <?php if($rows->total() > 0): ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="title">
                                            <a href="<?php echo e(url('admin/module/page/edit/'.$row->id)); ?>"> <?php echo e($row->title); ?>  </a>
                                        </td>
                                        <td class="author">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/forkomdi/jobs.ciptawiratirta.com/modules/Page/Views/admin/index.blade.php ENDPATH**/ ?>