<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left"> 
                <?php if(!empty($rows)): ?>
                <form method="post" action="<?php echo e(url('admin/module/contact/bulkEdit')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/forkomdi/jobs.ciptawiratirta.com/modules/Contact/Views/admin/index.blade.php ENDPATH**/ ?>