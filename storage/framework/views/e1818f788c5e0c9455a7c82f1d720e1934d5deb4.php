<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(__("All company")); ?></h1>
            <div class="title-actions">
                <a href="<?php echo e(url('admin/module/company/create')); ?>" class="btn btn-primary"><?php echo e(__("Add new Company")); ?></a>
            </div>
        </div>
        ...
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                <?php if(!empty($rows)): ?>
                    <form method="post" action="<?php echo e(url('admin/module/company/bulkEdit')); ?>"
            ...
            <div class="col-left">
                <form method="get" action="<?php echo e(url('/admin/module/company/')); ?> " class="filter-form filter-form-right d-flex justify-content-end flex-column flex-sm-row" role="search">
                    ...
                    <button class="btn-info btn btn-icon btn_search" type="submit"><?php echo e(__('Search Company')); ?></button>
                </form>
            </div>
        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th width="130px"> <?php echo e(__('Employer')); ?></th>
                                    ...
                                    <?php if($rows->total() > 0): ?>
                                        <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="title">
                                                    <a href="<?php echo e($row->getEditUrl()); ?>"><?php echo e($row->name); ?></a>
                                                </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/forkomdi/jobs.ciptawiratirta.com/modules/Company/Views/admin/company/index.blade.php ENDPATH**/ ?>