        ...
        <form method="post" action="<?php echo e(route('LaravelInstaller::environmentSaveWizard')); ?>" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group <?php echo e($errors->has('app_name') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="app_name" id="app_name" value="Superio" placeholder="<?php echo e(trans('installer_messages.environment.wizard.form.app_name_placeholder')); ?>" />
                ...
                <div class="form-group <?php echo e($errors->has('app_debug') ? ' has-error ' : ''); ?>" style="display: none">
                    ...
                    <label for="app_debug_false">
                        <input type="radio" name="app_debug" checked id="app_debug_false" value=0 />
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbook/GitHub/superio200/resources/views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>