    ...
    <nav class="ls-pagination">
        <ul class="pagination">
            ...
            <?php if($paginator->hasMorePages()): ?>
                <li>
                    <a href="<?php echo e($paginator->nextPageUrl()); ?>" rel="next" aria-label="<?php echo app('translator')->get('pagination.next'); ?>"><i class="fa fa-arrow-right"></i></a>
                </li>
            <?php else: ?>
...
<?php endif; ?>
<?php /**PATH /home/forkomdi/jobs.ciptawiratirta.com/resources/views/vendor/pagination/news-pagination.blade.php ENDPATH**/ ?>