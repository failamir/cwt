<!-- Job Overview -->
<h4 class="widget-title"><?php echo e(__("Job Overview")); ?></h4>
<div class="widget-content">
    <ul class="job-overview">
        <?php if($row->created_at): ?>
            <li>
                <i class="icon icon-calendar"></i>
                <h5><?php echo e(__("Date Posted:")); ?></h5>
                <span><?php echo e(__("Posted :time_ago", ['time_ago' => $row->timeAgo()])); ?></span>
            </li>
        <?php endif; ?>
        <?php if($row->expiration_date): ?>
            <li>
                <i class="icon icon-expiry"></i>
                <h5><?php echo e(__("Expiration date:")); ?></h5>
                <span><?php echo e(display_date($row->expiration_date)); ?></span>
            </li>
        <?php endif; ?>
        <?php if($row->location): ?>
            ...
            <li>
                ...
                <span><?php echo e($location_translation->name); ?></span>
            </li>
        <?php endif; ?>
        <?php if($row->hours): ?>
            <li>
                <i class="icon icon-clock"></i>
                <h5><?php echo e(__("Hours:")); ?></h5>
                <span><?php echo e($row->hours); ?> <?php if($row->hours_type): ?>/ <?php echo e($row->hours_type); ?> <?php endif; ?></span>
            </li>
        <?php endif; ?>
        <?php if($row->salary_min && $row->salary_max): ?>
            <li>
                <i class="icon icon-salary"></i>
                <h5><?php echo e(__("Salary:")); ?></h5>
                <span><?php echo e($row->getSalary()); ?></span>
            </li>
        <?php endif; ?>
        <li>
            <span class="icon">
            ...
            <span>
                <?php if(empty($row->experience) || (float)$row->experience < 1): ?>
                    <?php echo e(__("Fresh")); ?>

                <?php else: ?>
                    <?php echo e($row->experience); ?> <?php echo e($row->experience > 1 ? __("years") : __("year")); ?>
        ...
        <?php if($row->gender): ?>
            <li>
                ...
                <span><?php echo e($row->gender); ?></span>
            </li>
        <?php endif; ?>
    </ul>
</div>
<?php /**PATH /Users/macbook/Sites/localhost/superio200/modules/Job/Views/frontend/layouts/details/overview.blade.php ENDPATH**/ ?>