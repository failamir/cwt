                                    ...
                                    <?php if($rows->total() > 0): ?>
                                        <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($row->job): ?>
                                                        <a href="<?php echo e($row->job->getDetailUrl()); ?>" target="_blank"><?php echo e($row->job->title); ?></a>
                                                    <?php endif; ?>
                                                </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/forkomdi/jobs.ciptawiratirta.com/modules/Company/Views/admin/company/my-contact.blade.php ENDPATH**/ ?>