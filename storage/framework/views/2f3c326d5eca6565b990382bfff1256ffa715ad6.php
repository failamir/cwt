<?php if(!empty($seo_meta)): ?>
    ...
    <?php
        ...
        if(!empty($page_title) and empty($seo_meta['is_homepage'])){
            $page_title .= " - ".setting_item_with_lang('site_title' ,false,'Superio');
        }
        if(empty($page_title)){
            $page_title = setting_item_with_lang('site_title' ,false,'Superio');
        }
...
<?php endif; ?>
<?php /**PATH /Users/macbook/Sites/localhost/superio200/modules/Layout/parts/seo-meta.blade.php ENDPATH**/ ?>