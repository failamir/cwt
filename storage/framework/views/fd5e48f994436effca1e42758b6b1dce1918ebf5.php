        ...
        <div class="row">
            <div class="col-md-4 mb40">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form action="<?php echo e(route('job.admin.category.store',['id'=>-1])); ?>" method="post">
                            <?php echo csrf_field(); ?>
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        <?php if(!empty($rows)): ?>
                            <form method="post" action="<?php echo e(url('admin/module/job/category/bulkEdit')); ?>"
                            ...
                            <table class="table table-hover">
                                ...
                                <?php if(count($rows) > 0): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="title">
                                            <a href="<?php echo e(url('admin/module/job/category/edit/'.$row->id)); ?>"><?php echo e($prefix.' '.$translate->name); ?></a>
                                        </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbook/Sites/localhost/superio200/modules/Job/Views/admin/category/index.blade.php ENDPATH**/ ?>