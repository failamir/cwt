                    ...
                    <div class="content">
                        ...
                        <ul class="job-info">
                            <?php if($row->location): ?>
                                ...
                                <li><span class="icon flaticon-map-locator"></span> <?php echo e($location->name); ?></li>
                            <?php endif; ?>
                            <?php if($row->category): ?>
...
<?php /**PATH /Users/macbook/Sites/localhost/superio200/modules/Company/Views/frontend/layouts/details/ver/company-single-v1.blade.php ENDPATH**/ ?>